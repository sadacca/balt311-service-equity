"""Equity scoring primitives shared by the within-Baltimore app (`app/components/utils.py`
re-exports these) and the cross-city equity pipeline (Phase 5.5-3), so both compute the
same Mann-Whitney overlap score and volume-weighted mean from one implementation."""
import numpy as np
import pandas as pd
